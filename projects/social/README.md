...
500 - 100 users need 10 friends each, but each time you call addFriendship() it adds one friend to two separate users

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? (63.25%, because the other users will (on average) not have any friends) What is the average degree of separation between a user and those in his/her extended network?
